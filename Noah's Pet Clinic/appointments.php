...
<!--from here down...(Evan) -->
    ...
    <title>NPC Noah's Pet Clinic, Manchester: Confirm appointment request</title>
  </head>
  <body>
...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      ...
      $sql = "INSERT INTO appointments (customerName, customerEmail, customerPhone, appDate, appTime, comments) VALUES ('$customerName', '$customerEmail', '$customerPhone', '$appDate', '$appTime', '$comments')";

      if ($conn->query($sql) === TRUE) {
          echo "Appointment request submitted successfully.";
          echo "<br>";
          echo "Reception will confirm within 10 minutes.";
      } else {
